...
public:
  ...
  void handleSYCLIntelMinWorkGroupsPerComputeUnitAttr(Decl *D, const ParsedAttr &AL);
  void handleSYCLIntelMaxWorkGroupsPerMultiprocessorAttr(Decl *D, const ParsedAttr &AL);
  ...
  static bool AnyWorkGroupSizesDiffer(const Expr *LHSXDim, const Expr *LHSYDim,
                                      const Expr *LHSZDim, const Expr *RHSXDim,
                                      const Expr *RHSYDim, const Expr *RHSZDim);
  static bool AllWorkGroupSizesSame(const Expr *LHSXDim, const Expr *LHSYDim,
                                    const Expr *LHSZDim, const Expr *RHSXDim,
                                    const Expr *RHSYDim, const Expr *RHSZDim);
  ...
  void addSYCLIntelNoGlobalWorkOffsetAttr(Decl *D,
                                              const AttributeCommonInfo &CI,
                                              Expr *E);
  void addSYCLIntelMaxGlobalWorkDimAttr(Decl *D,
                                              const AttributeCommonInfo &CI,
                                              Expr *E);
  ...
  void addSYCLIntelMaxWorkGroupsPerMultiprocessorAttr(
      Decl *D, const AttributeCommonInfo &CI, Expr *E);
  void addSYCLIntelMaxConcurrencyAttr(
      Decl *D, const AttributeCommonInfo &CI, Expr *E);
  void addSYCLIntelPrivateCopiesAttr(
      Decl *D, const AttributeCommonInfo &CI, Expr *E);
  void addSYCLIntelMaxReplicatesAttr(
      Decl *D, const AttributeCommonInfo &CI, Expr *E);
  void addSYCLIntelInitiationIntervalAttr(
      Decl *D, const AttributeCommonInfo &CI, Expr *E);
  void addSYCLIntelESimdVectorizeAttr(
      Decl *D, const AttributeCommonInfo &CI, Expr *E);
